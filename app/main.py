...
This script initializes the app, sets up routes, and starts the server.
"""
...
def get_weather_service() -> WeatherService:
    ...
    logging.debug("TESTING = %s", {env_true("MOCK_HTTP_REQUESTS")})
...
async def get_weather_by_path(
    ...
    country_code: Optional[str] = Query(
        ...
        min_length=2,
        max_length=2,
        description="Optional 2-letter ISO_3166 country code",
    ),
